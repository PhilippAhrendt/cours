...
def calendrier_parties(joueurs):
    ...
    for k in range(1,len(joueurs)-1):
        ...
        if len(joueurs) == 4:
            ...
            parties_suivant.append(Partie(parties[k-1][0].joueur_droite, parties[k-1][1].joueur_droite))
            for l in range(1,len(parties[k-1])-2):
                parties_suivant.append(Partie(parties[k-1][l-1].joueur_gauche, parties[k-1][l+1].joueur_droite))
            parties_suivant.append(Partie(parties[k-1][-3].joueur_gauche, parties[k-1][-1].joueur_gauche))
