#+title: Introduction Python: Exercices 1
...
Pour tester cette fonction, vous pouvez utiliser, par exemple des fonctions puissances, et les tester contre les racines /n/-ièmes.
...
L'algorithme de recherche dichotomique consiste à diminuer progressivement l'intervalle dans lequel on cherche /g(n)/. A chaque étape, on a un intervalle [​/k/​_​/min/,​/k/​_​/max/​], et on prend /k/ dans cet intervalle. Si /k/ est plus grand que /g(n)/, on remplace /k/​_​/max/ par /k/, et on cherche relance la recherche dans ​[​/k/​_​/min/,​/k/​], et si /k/ est plus petit, on remplace /k/​_​/min/ et relance. On répète cela jusqu'à ce qu'on trouve /g(n)/. Voici une manière d'implémenter cela:

1. Initialiser:
   - /k/​_​/min <- 0/
   - /k/​_​/max <- n/
2. Tant que /g(n)/ n'est pas trouvée:
   - /k <- partie entière de (k/​_​/min+k/​_​/max)/​/​2
   - Si /f(k)/​\le​/n/:
...
#  LocalWords:  d'Euclide pgcd i.e algorithmiquement ièmes Pouvez-vous peut-on
